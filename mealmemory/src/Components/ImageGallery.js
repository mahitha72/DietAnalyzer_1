...
const ImageGallery = () => {
  ...
  const images = [
    ...
    },
    {
      ...
      description:"Log your meals effortlessly and track nutritional values to maintain a balanced diet. Monitor calories, macronutrients, and vitamins to stay healthy and reach your fitness goals"
    }
